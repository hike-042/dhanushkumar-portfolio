...
export default function SiteBackground() {
  const { isMobile, isTablet, prefersReducedMotion } = useDeviceProfile()
  const showHeavyAmbient = !(isMobile || prefersReducedMotion)
  const showParticles = !(isMobile || isTablet || prefersReducedMotion)
  ...
  return (
    ...
    >
      {showHeavyAmbient && (
        <div
          className="site-blob site-blob-a"
          style={{
            position: 'absolute',
            top: '-15%',
            left: '-10%',
      ...
      {showHeavyAmbient && (
        <div
          className="site-blob site-blob-b"
          style={{
            position: 'absolute',
            bottom: '-20%',
            right: '-12%',
      ...
      {showHeavyAmbient && (
        <div
          className="site-blob site-blob-c"
          style={{
            position: 'absolute',
            top: '40%',
            right: '20%',
