...
const COMMANDS = [
  { id: 'hero',       label: 'Home',               icon: '🏠', action: 'scroll',  target: '#hero'       },
  { id: 'about',      label: 'About Me',            icon: '👤', action: 'scroll',  target: '#about'      },
  { id: 'experience', label: 'Experience',          icon: '💼', action: 'scroll',  target: '#experience' },
  { id: 'projects',   label: 'Projects',            icon: '🚀', action: 'scroll',  target: '#projects'   },
  { id: 'persona',    label: 'The Person',          icon: '✨', action: 'scroll',  target: '#persona'    },
  { id: 'contact',    label: 'Contact',             icon: '📬', action: 'scroll',  target: '#contact'    },
  { id: 'email',      label: 'Copy Email',          icon: '📋', action: 'copy',    target: 'official.dhanushkumar.r@gmail.com' },
  { id: 'linkedin',   label: 'Open LinkedIn',       icon: '🔗', action: 'link',    target: 'https://www.linkedin.com/in/dhanush-kumar-97a6b5182/' },
  { id: 'github',     label: 'Open GitHub',         icon: '💻', action: 'link',    target: 'https://github.com/hike-042' },
  { id: 'theme',      label: 'Toggle Theme',        icon: '🌓', action: 'theme',   target: '' },
]
        ...
        {open && (
          <>
            ...
            >
              ...
              {/* Results */}
              <div
                style={{ maxHeight: 'min(360px, calc(100vh - 220px))', overflowY: 'auto', padding: '8px', overscrollBehavior: 'contain' }}
                onWheel={e => e.stopPropagation()}
              >
                {filtered.length === 0 ? (
                  <p style={{ textAlign: 'center', color: 'var(--text-3)', fontSize: '.88rem', padding: '24px 0' }}>
                    No results found
                  </p>
                ) : (
                  filtered.map((cmd, i) => (
